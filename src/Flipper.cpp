...
void Flipper::Loop()
{
	...
	{
		 bool flipupbutton = false;//m_inputs->xBoxAButton(OperatorInputs::ToggleChoice::kToggle, 1);
	...
	{
		bool flipbutton = false;//m_inputs->xBoxAButton(OperatorInputs::ToggleChoice::kToggle, 1);
